...
var dropDownOptions = {
    title : "Dropdown",
    data : [],
    closedArrow : '<i class="fa fa-plus-square-o" aria-hidden="true"></i>',
    openedArrow : '<i class="fa fa-minus-square-o" aria-hidden="true"></i>',
    maxHeight : 300,
    multiSelect : false,
...
(function($) {
    ...
    if(options.rtl){
        ...
        if(options.closedArrow.indexOf("fa-plus-square-o")>-1){
            options.closedArrow = options.closedArrow.replace("fa-plus-square-o","fa-minus-square-o");
        } 
    }
    $(options.element).append('<button class="btn3 dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true"><span class="dropdowntree-name">'+options.title+'</span> <span class="caret"></span></button>');
